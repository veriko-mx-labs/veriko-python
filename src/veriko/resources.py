...
`client.catalog` y las demás. Los tres métodos de uso más frecuente siguen en la raíz
del cliente, porque son el camino corto del caso de uso principal.
"""
...
class Plans(_Resource):
    """Catálogo de planes públicos, sin clave de API."""
